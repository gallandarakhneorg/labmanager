...
public class SingleJournalNameField extends AbstractSingleEntityNameField<Journal> {
	 ...
	 *      This second lambda takes the created journal.
	 */
	public SingleJournalNameField(JournalService journalService, SerializableBiConsumer<Journal, Consumer<Journal>> creationWithUiCallback,
	 ...
	 */
	public SingleJournalNameField(JournalService journalService, AuthenticatedUser authenticatedUser, String creationTitle, Logger logger) {
		this(journalService,
				(newJournal, saver) -> {
