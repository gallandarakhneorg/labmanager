 ...
 * @since 4.0
 */
public class LanguageSelectItemRenderer implements SerializableFunction<Locale, Component> {
	 ...
	 */
	public LanguageSelectItemRenderer(LanguageSelect parent) {
	...
	public Component apply(Locale item) {
		...
		if (parent != null) {
			...
			final Div name = new Div();
			name.setText(getLanguageName(parent, lang));
