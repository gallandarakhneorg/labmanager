...
public class PublicationImportWizard extends DefaultPublicationImportWizard {
	 ...
	 */
	public PublicationImportWizard(@Autowired PublicationService publicationService,
			@Autowired PublicationEditorFactory editorFactory,
			@Autowired PublicationCreationStatusComputer statusComputer,
			@Autowired MessageSourceAccessor messages) {
		super(publicationService, editorFactory, statusComputer, messages);
	}
