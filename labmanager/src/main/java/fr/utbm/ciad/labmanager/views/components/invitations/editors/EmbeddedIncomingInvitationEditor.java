...
public final class EmbeddedIncomingInvitationEditor extends AbstractIncomingInvitationEditor {
	...
	public EmbeddedIncomingInvitationEditor(EntityEditingContext<PersonInvitation> context,
			PersonService personService, PersonEditorFactory personEditorFactory, UserService userService, AuthenticatedUser authenticatedUser, MessageSourceAccessor messages) {
		super(context, false, personService, personEditorFactory, userService, authenticatedUser, messages, LOGGER);
