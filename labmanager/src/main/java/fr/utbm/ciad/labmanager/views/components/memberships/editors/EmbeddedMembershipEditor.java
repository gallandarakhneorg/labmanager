...
public final class EmbeddedMembershipEditor extends AbstractMembershipEditor {
	...
	public EmbeddedMembershipEditor(EntityEditingContext<Membership> context,
			boolean editAssociatedPerson, PersonService personService, PersonEditorFactory personEditorFactory, UserService userService,
		...
		super(context, editAssociatedPerson, false, personService, personEditorFactory, userService,
				organizationService, organizationEditorFactory, addressService,
				axisService, authenticatedUser, messages, LOGGER);
