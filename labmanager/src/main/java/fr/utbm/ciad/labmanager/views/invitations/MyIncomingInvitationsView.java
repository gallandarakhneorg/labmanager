...
/** Enable to edit the incoming invitations by the user.
 * 
 ...
 * @since 4.0
 */
@PageTitle("My Incoming Invitations")
@Route(value = "myinvitationsin", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyIncomingInvitationsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public MyIncomingInvitationsView() {
