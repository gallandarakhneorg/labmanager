...
public abstract class AbstractProjectEditor extends AbstractEntityEditor<Project> {
	...
	protected void createConsortiumDetails(VerticalLayout rootContainer) {
		...
		this.coordinator = new SingleOrganizationNameField(this.organizationService, this.addressService, this.organizationEditorFactory, getAuthenticatedUser(),
		...
		this.participants = new ProjectMemberListGridField(this.personService, this.personEditorFactory, this.userService, getAuthenticatedUser(), getMessageSourceAccessor(), getLogger());
	...
	protected void openOtherPartnerEditor(Consumer<ResearchOrganization> saver) {
		...
		final var editor = this.organizationEditorFactory.createAdditionEditor(
	...
	protected void createFundingDetails(VerticalLayout rootContainer) {
		...
		this.learOrganization = new SingleOrganizationNameField(this.organizationService, this.addressService, this.organizationEditorFactory, getAuthenticatedUser(),
				getTranslation("views.projects.new_organization"), getLogger(), null); //$NON-NLS-1$
