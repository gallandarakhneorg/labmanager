...
public class PersonCardView extends AbstractPersonCardView<Person> {
    ...
    public PersonCardView(Person person, PersonService personService, PersonEditorFactory personEditorFactory, UserService userService, AuthenticatedUser authenticatedUser, MessageSourceAccessor messages, MembershipService membershipService, ChronoMembershipComparator membershipComparator) {
    ...
    protected void openPersonEditor(Person person, String title) {
        ...
        final var editor = this.personEditorFactory.createAdditionEditor(
