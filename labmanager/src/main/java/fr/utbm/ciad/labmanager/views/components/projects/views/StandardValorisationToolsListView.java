...
public class StandardValorisationToolsListView extends AbstractPublicationListView {
	 ...
	 * @param journalEditorFactory the factoty for creating the journal editors.
	...
	public StandardValorisationToolsListView(
		...
		super(fileManager, authenticatedUser, messages, publicationService, publicationEditorFactory, personService, personEditorFactory,
				...
				"views.tools.delete.title", //$NON-NLS-1$
				"views.tools.delete.message", //$NON-NLS-1$
				"views.tools.delete.success_message", //$NON-NLS-1$
				"views.tools.delete.error_message", //$NON-NLS-1$
