...
package fr.utbm.ciad.labmanager.views.journals;
...
@PermitAll
@Uses(Icon.class)
public class JournalsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 3916124751348269814L;
