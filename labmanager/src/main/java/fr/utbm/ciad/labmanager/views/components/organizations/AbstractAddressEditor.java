...
import fr.utbm.ciad.labmanager.views.components.uploads.ServerSideUploadableImageField;
import fr.utbm.ciad.labmanager.views.components.validators.GpsCoordinatesValidator;
