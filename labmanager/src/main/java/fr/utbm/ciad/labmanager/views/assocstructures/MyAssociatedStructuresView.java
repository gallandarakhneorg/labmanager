...
package fr.utbm.ciad.labmanager.views.assocstructures;
...
/** Enable to edit the associated structures of the user.
 * 
 ...
 * @since 4.0
 */
@PageTitle("My Associated Structures")
@Route(value = "myassocstructures", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyAssociatedStructuresView extends Composite<VerticalLayout> {
