...
public final class EmbeddedSupervisionEditor extends AbstractSupervisionEditor {
	...
	public EmbeddedSupervisionEditor(EntityEditingContext<Supervision> context,
		...
		super(context, false, membershipService, personService, personEditorFactory, userService,
				organizationService, organizationEditorFactory,
				addressService, axisService, authenticatedUser,
				messages, LOGGER);
