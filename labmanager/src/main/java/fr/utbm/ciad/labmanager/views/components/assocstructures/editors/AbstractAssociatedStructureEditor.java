...
public abstract class AbstractAssociatedStructureEditor extends AbstractEntityEditor<AssociatedStructure> {
	...
	protected void createCreationDetails(VerticalLayout rootContainer) {
		...
		this.holders = new AssociatedStructureHolderListGridField(
				...
				this.organizationEditorFactory, getAuthenticatedUser(),
	...
	protected void createFundingDetails(VerticalLayout rootContainer) {
		...
		this.fundingOrganization = new SingleOrganizationNameField(this.organizationService, this.addressService,
				this.organizationEditorFactory, getAuthenticatedUser(),
	...
	protected void openProjectEditor(Consumer<Project> saver) {
		...
		final var editor = new EmbeddedProjectEditor(
				...
				this.organizationEditorFactory, this.projectService.getFileManager(),
