...
import fr.utbm.ciad.labmanager.components.indicators.publication.count.UnrankedJournalPaperCountIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.count.WosJournalPaperCountIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ConferencePaperFteRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ConferencePaperPhdRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ConferencePaperPostdocRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ScimagoJournalPaperFteRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ScimagoJournalPaperPhdRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.ScimagoJournalPaperPostdocRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.WosJournalPaperFteRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.WosJournalPaperPhdRatioIndicator;
import fr.utbm.ciad.labmanager.components.indicators.publication.fte.WosJournalPaperPostdocRatioIndicator;
