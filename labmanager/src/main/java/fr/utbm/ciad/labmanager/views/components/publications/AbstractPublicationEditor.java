...
/** Abstract implementation for the editor of the information related to a publication.
 * 
 ...
 */
@Uses(Icon.class)
public abstract class AbstractPublicationEditor extends AbstractEntityEditor<ScientificAxis> {
	 ...
	 */
	public AbstractPublicationEditor(EditingContext context, AuthenticatedUser authenticatedUser,
