...
public final class EmbeddedProjectEditor extends AbstractProjectEditor {
	...
	public EmbeddedProjectEditor(EntityEditingContext<Project> context,
		...
		super(context, false, organizationService, addressService, personService, personEditorFactory,
				userService, axisService, organizationEditorFactory, fileManager, authenticatedUser,
				messages, LOGGER);
