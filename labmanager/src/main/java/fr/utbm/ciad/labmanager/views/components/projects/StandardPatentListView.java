...
public class StandardPatentListView extends AbstractPublicationListView {
	...
	public StandardPatentListView(
		...
		super(fileManager, authenticatedUser, messages, publicationService, personService,
				...
				"views.patents.delete.title", //$NON-NLS-1$
				"views.patents.delete.message", //$NON-NLS-1$
				"views.patents.delete.success_message", //$NON-NLS-1$
				"views.patents.delete.error_message", //$NON-NLS-1$
