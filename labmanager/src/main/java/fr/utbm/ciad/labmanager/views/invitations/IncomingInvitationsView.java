...
/** Enable to edit the incoming invitations.
 * 
 ...
 * @since 4.0
 */
@PageTitle("Incoming Invitations")
@Route(value = "invitationsin", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class IncomingInvitationsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public IncomingInvitationsView() {
