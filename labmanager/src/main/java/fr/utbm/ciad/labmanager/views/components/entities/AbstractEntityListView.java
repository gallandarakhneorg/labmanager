...
package fr.utbm.ciad.labmanager.views.components.entities;
...
/** Abstract implementation of a list of entities.
 *
...
public abstract class AbstractEntityListView<T extends IdentifiableEntity> extends Composite<VerticalLayout> implements LocaleChangeObserver {

	private static final long serialVersionUID = -2408935045561976570L;
	 ...
	 * @return the filters
	 */
	protected abstract Filters<T> createFilters();
	 ...
	 */
	protected abstract boolean createGridColumns(Grid<T> grid);
	...
	private Grid<T> createGrid() {
		final var grid = new Grid<>(getEntityType(), false);
	...
	/** UI and JPA filters for {@link AbstractEntityListView}.
	 * 
