...
public abstract class AbstractMembershipEditor extends AbstractEntityEditor<Membership> {
	...
	public AbstractMembershipEditor(EntityEditingContext<Membership> context, boolean editAssociatedPerson,
			boolean relinkEntityWhenSaving, PersonService personService, PersonEditorFactory personEditorFactory, UserService userService,
	...
	protected void createEmployeeDetails(VerticalLayout rootContainer) {
		...
		this.person = new SinglePersonNameField(this.personService, this.personEditorFactory, this.userService, getAuthenticatedUser(),
	...
	protected void createEmployerDetails(VerticalLayout rootContainer) {
		...
		this.serviceOrganization = new SingleOrganizationNameField(this.organizationService, this.addressService, this.organizationEditorFactory, getAuthenticatedUser(),
		...
		this.employerOrganization = new SingleOrganizationNameField(this.organizationService, this.addressService, this.organizationEditorFactory, getAuthenticatedUser(),
