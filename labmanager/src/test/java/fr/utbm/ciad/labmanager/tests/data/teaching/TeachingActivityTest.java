...
public class TeachingActivityTest {
	...
	public void setPedagogicalPracticeTypes() {
	 ...
	 private static TeachingActivity createTransient1() {
		 var e = new TeachingActivity();
		 e.setCode("A");
		 return e;
	 }	

	 private static TeachingActivity createTransient2() {
		 var e = new TeachingActivity();
		 e.setCode("B");
		 return e;
	 }	

	 private static TeachingActivity createManaged1() {
		 var e = createTransient1();
		 e.setId(10l);
		 return e;
	 }	

	 private static TeachingActivity createManaged2() {
