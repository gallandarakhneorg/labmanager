...
package fr.utbm.ciad.labmanager.tests.components;
...
public class AbstractCredentialControllerTest {
	...
	/** Mock for {@link AbstractCredentialController}.
	 * 
	 * @author $Author: sgalland$
	 * @version $Name$ $Revision$ $Date$
	 * @mavengroupid $GroupId$
	 * @mavenartifactid $ArtifactId$
	 */
	private static class CredentialControllerMock extends AbstractCredentialController {

		public CredentialControllerMock(MessageSourceAccessor messages, Constants constants,
				String usernameKey) {
			super(messages, constants, usernameKey);
		}
		
		@Override
		public String readCredentials(String encryptedUsername, String serviceName, Object... serviceParams) {
			return super.readCredentials(encryptedUsername, serviceName, serviceParams);
		}
