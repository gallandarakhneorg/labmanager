...
import fr.utbm.ciad.labmanager.utils.io.html.CiadHtmlPageExporter;
...
public class CiadHtmlPageExporterTest {
	...
	public void setUp() throws Exception {
		...
		this.test = new CiadHtmlPageExporter(new Constants(), this.messages, this.doiTools, this.halTools);
	}
