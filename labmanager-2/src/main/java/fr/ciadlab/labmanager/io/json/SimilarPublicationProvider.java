...
public interface SimilarPublicationProvider {
	...
	/** Replies a publication that corresponds to the given source. The replied publication is
	 * assumed to be different than the source.
	 *
	 * @param source the publication source.
	 * @return the additional publication.
	 */
	Publication get(Publication source);
