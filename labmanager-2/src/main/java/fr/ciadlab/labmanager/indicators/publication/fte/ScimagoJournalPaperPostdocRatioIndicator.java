...
import fr.ciadlab.labmanager.indicators.publication.count.PostdocScimagoJournalPaperCountIndicator;
...
public class ScimagoJournalPaperPostdocRatioIndicator extends AbstractRankedJournalPaperFteRatioIndicator {
	...
	public String getName() {
		return getMessage("scimagoJournalPaperPostdocRatioIndicator.name"); //$NON-NLS-1$
	}

	@Override
	public String getLabel(Unit unit) {
		return getLabelWithYears("scimagoJournalPaperPostdocRatioIndicator.label"); //$NON-NLS-1$
	}
