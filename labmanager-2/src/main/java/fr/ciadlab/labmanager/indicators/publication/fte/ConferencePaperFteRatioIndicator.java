...
public class ConferencePaperFteRatioIndicator extends AbstractAnnualIndicator {
	...
	private ConferencePaperCountIndicator paperCount;
	...
	public String getName() {
		return getMessage("conferencePaperFteRatioIndicator.name"); //$NON-NLS-1$
	}

	@Override
	public String getLabel(Unit unit) {
		return getMessage("conferencePaperFteRatioIndicator.label"); //$NON-NLS-1$
	}
