...
public class PostdocWosJournalPaperCountIndicator extends AbstractRankedJournalPaperCountIndicator {
	...
	public String getName() {
		return getMessage("postdocWosJournalPaperCountIndicator.name", getJournalRankingSystem().getLabel()); //$NON-NLS-1$
	}

	@Override
	public String getLabel(Unit unit) {
		return getLabelWithYears("postdocWosJournalPaperCountIndicator.label", getJournalRankingSystem().getLabel()); //$NON-NLS-1$
	}
