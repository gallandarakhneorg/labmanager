...
package fr.utbm.ciad.labmanager.views.teaching;
 ...
 * @since 4.0
 */
@PageTitle("My Teaching Activities")
@Route(value = "myteaching", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyTeachingActivitiesView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public MyTeachingActivitiesView() {
