...
/** Enable to edit the outgoing invitations.
 * 
 ...
 * @since 4.0
 */
@PageTitle("Outgoing Invitations")
@Route(value = "invitationsout", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class OutgoingInvitationsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public OutgoingInvitationsView() {
