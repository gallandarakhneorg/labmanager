...
package fr.utbm.ciad.labmanager.views.publications;
...
/** Enable to edit the publications for the user.
 * 
...
@Route(value = "mypublications", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyPublicationsView extends Composite<VerticalLayout> {
