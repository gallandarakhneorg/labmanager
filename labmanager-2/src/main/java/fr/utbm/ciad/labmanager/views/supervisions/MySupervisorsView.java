...
/** Enable to edit the supervisors for the user.
 * 
 ...
 * @since 4.0
 */
@PageTitle("My Supervisors")
@Route(value = "mysupervisors", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MySupervisorsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public MySupervisorsView() {
