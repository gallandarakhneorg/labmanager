...
package fr.utbm.ciad.labmanager.views.invitations;
...
/** Enable to edit the outgoing invitations for the user.
 * 
 ...
 * @since 4.0
 */
@PageTitle("My Outgoing Invitations")
@Route(value = "myinvitationsout", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyOutgoingInvitationsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public MyOutgoingInvitationsView() {
