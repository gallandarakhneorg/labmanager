...
package fr.utbm.ciad.labmanager.views.jurys;
...
/** Enable to edit the jurys in which the user was involved.
 * 
 ...
 */
@PageTitle("My Jurys")
@Route(value = "myjurys", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MyJurysView extends Composite<VerticalLayout> {
