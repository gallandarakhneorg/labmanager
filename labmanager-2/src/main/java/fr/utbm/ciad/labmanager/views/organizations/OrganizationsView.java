...
package fr.utbm.ciad.labmanager.views.organizations;
...
@PermitAll
@Uses(Icon.class)
public class OrganizationsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = -4012682743375680770L;
