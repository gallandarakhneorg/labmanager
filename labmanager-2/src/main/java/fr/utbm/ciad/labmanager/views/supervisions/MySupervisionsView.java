...
package fr.utbm.ciad.labmanager.views.supervisions;
...
/** Enable to edit the supervisions for the user.
 * 
 ...
 * @since 4.0
 */
@PageTitle("My Supervisions")
@Route(value = "mysupervisions", layout = MainLayout.class)
@PermitAll
@Uses(Icon.class)
public class MySupervisionsView extends Composite<VerticalLayout> {

	private static final long serialVersionUID = 738063190104767506L;

	/** Constructor.
	 */
    public MySupervisionsView() {
